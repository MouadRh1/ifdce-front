...
import { Database, Calculator, Briefcase, FileText, Building, Home, GraduationCap, Globe, HardHat, MapPin, Compass } from 'lucide-react';
import studentimage9 from '../assets/pexels-pixabay-159213.jpg'
import { Link } from 'react-router-dom';

const LicenceProfessionnelle = () => {
  const programs = [
    // NOUVELLES LICENCES EN PREMIER (demandées par le client)
    {
      id: 1,
  ...
  const categories = ["Tous", "Géomatique", "Génie Civil", "Technologie", "Finance", "Management", "Juridique", "Ingénierie"];
          ...
          {filteredPrograms.map((program, index) => (
            <div
              ...
              className={`group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 overflow-hidden ${
                program.isFeatured ? 'ring-2 ring-blue-500 ring-offset-2' : ''
              }`}
              style={{
