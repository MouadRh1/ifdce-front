...
import { Brain, Users, Award, Banknote, Calculator, Building2, Home, Palette, Construction, GraduationCap, Globe, HardHat, Compass } from 'lucide-react';
import { 
    Shield,
    Leaf,
    TrendingUp,
...
const MasterProfessionnel = () => {
    const programs = [
        // NOUVEAUX MASTERS EN PREMIER (demandés par le client)
        {
            ...
            description: "Formation d'excellence en géomatique et ingénierie topographique. Maîtrise des systèmes d'information géographique (SIG), télédétection, cartographie numérique et gestion de projets géospatiaux. Préparation aux métiers d'expert en géomatique, chef de projet SIG et ingénieur topographe.",
        ...
        },
        {
            ...
            description: "Programme avancé en génie civil et ingénierie topographique. Formation aux techniques de conception, calcul de structures, gestion de projets d'infrastructure et topographie de précision. Préparation aux métiers d'ingénieur en génie civil, chef de projet BTP et expert en infrastructures.",
    ...
    const categories = ["Tous", "Géomatique", "Génie Civil", "Psychologie", "Management", "Coaching", "Finance", "Business", "Design", "Ingénierie", "Informatique", "Environnement", "Marketing", "Ressources Humaines", "Intelligence Artificielle"];
