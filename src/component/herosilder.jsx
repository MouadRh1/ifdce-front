  ...
  return (
    <section className='h-screen relative flex items-center justify-center overflow-hidden'>
      ...
      <div className='z-10 text-center px-6 max-w-6xl mx-auto w-full hero-content'>
        ...
        {/* MODIFICATION: Nouveaux boutons principaux */}
        <div className={`flex gap-6 justify-center items-center flex-wrap transform transition-all duration-1000 delay-1000 hero-buttons ${
          isVisible ? 'translate-y-0 opacity-100' : 'translate-y-5 opacity-0'
        }`}>
          <Link to="/formations">
