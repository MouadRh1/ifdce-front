...
export default function Faqs() {
    ...
    const faqsList = [
        ...
        },
        {
            ...
            a: "L'IFDCE propose actuellement 4 formations prioritaires : la Licence Professionnelle en Géomatique et Ingénierie Topographique, la Licence Professionnelle en Génie Civil et Ingénierie Topographique, le Master Professionnel en Géomatique et Ingénierie Topographique, et le Master Professionnel en Génie Civil et Ingénierie Topographique. Ces formations sont proposées en mode hybride ."
        }
    ];
