...
export default function AdminDashboard() {
    ...
    const fetchDashboardData = async () => {
        try {
            const response = await axios.get('linen-sheep-933989.hostingersite.com/api/admin/dashboard');
    ...
    const fetchUsers = async (page = 1, search = '', role = '') => {
        try {
            ...
            const response = await axios.get(`https://linen-sheep-933989.hostingersite.com/api/admin/users?${params}`);
    ...
    const fetchEnrollments = async (page = 1, search = '', status = '') => {
        try {
            ...
            const response = await axios.get(`https://linen-sheep-933989.hostingersite.com/api/admin/enrollments?${params}`);
    ...
    const fetchEnrollmentStats = async () => {
        try {
            const response = await axios.get('https://linen-sheep-933989.hostingersite.com/api/admin/enrollments/stats');
    ...
    const fetchUserApplications = async (userId) => {
        try {
            const response = await axios.get(`https://linen-sheep-933989.hostingersite.com/api/admin/users/${userId}/applications`);
    ...
    const updateApplicationStatus = async (applicationId, newStatus) => {
        try {
            await axios.put(`https://linen-sheep-933989.hostingersite.com/api/admin/applications/${applicationId}/status`, {
                status: newStatus
            });
    ...
    const updateUserRole = async (userId, newRole) => {
        try {
            await axios.put(`https://linen-sheep-933989.hostingersite.com/api/admin/users/${userId}/role`, {
                role: newRole
            });
    ...
    const deleteUser = async (userId) => {
        ...
        try {
            await axios.delete(`https://linen-sheep-933989.hostingersite.com/api/admin/users/${userId}`);
            fetchUsers(currentPage, searchTerm, roleFilter);
